...
export const buildScenePrompt = ({ title, storyContext, userPrompt, worldBibleSnippet, memory, playerState }) => {
  ...
  return [
    ...
    '- Prefer concrete, verifiable details over atmosphere. At most ONE sentence may be purely mood/atmosphere.',
    '- Avoid generic mood-forward adjectives (eerie, ominous, haunting, mysterious, surreal, dreamlike, uncanny) unless explicitly present in Resolved Scene Notes or World Bible.',
    '- Use World Bible only to stay consistent with established canon. Do not add scene-specific details unless supported by Resolved Scene Notes, Player State, or Long-term Memory.',
